...
contract Pausable is Ownable {
    ...
    function setPaused(bool paused) public onlyOwner {
        require(_paused != paused, "Contract is already in this state.");
        _paused = paused;
        if (_paused) {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "Address is already the owner of this token.");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId], msg.sender), "Sender is not the owner of this token.");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Sender cannot be the operator.");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data), "Transfer not fulfilled.");
    }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "Sender is not the owner of this token.");
...
contract CustomERC721Token is ERC721Metadata("ImmoCoin", "IMO", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
